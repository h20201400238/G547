...
/* Description: A user level test program to check the ioctl functionality ofthe implemented Linux device driver, which controls a 16x2 character LCD (with HD44780 LCD controller) with 4 bit mode.
